package com.nadhifa.newsapp.activity
        ...
        if (fullName == ""){
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener { it ->
                if(it.isSuccessful){
                    ...
                    refUsers = FirebaseDatabase.getInstance().reference.child(getString(R.string.text_users)).child(firebaseUserId)
